var app = new Vue({
    ...
    methods: {
        sell(sellPrice) {
            ...
            if (this.sellPrice != "") {
                if (!isNaN(sellPrice)) {
                    ...
                    fetch("https://vehiclesales/sellVehicle", requestOptions);
                    this.close();
                } else {
        ...
        buy() {
            ...
            fetch("https://vehiclesales/buyVehicle", requestOptions);
            this.close();
        },
        takeBack() {
            const requestOptions = {
            ...
            fetch("https://vehiclesales/takeVehicleBack", requestOptions);
            this.close();
        },
        close() {
            const requestOptions = {
            ...
            fetch("https://vehiclesales/close", requestOptions);
