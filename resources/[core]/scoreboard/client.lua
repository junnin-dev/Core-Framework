...
RegisterNetEvent('Core:Client:OnPlayerLoaded', function()
    Core.Functions.TriggerCallback('scoreboard:server:GetConfig', function(config)
        Config.IllegalActions = config
    end)
end)

RegisterNetEvent('scoreboard:client:SetActivityBusy', function(activity, busy)
...
if Config.Toggle then
    RegisterCommand('scoreboard', function()
        if not scoreboardOpen then
            Core.Functions.TriggerCallback('scoreboard:server:GetScoreboardData', function(players, cops, playerList)
