...
RegisterNetEvent('police:client:spawnCone', function()
    Core.Functions.Progressbar("spawn_object", Lang:t("progressbar.place_object"), 2500, false, true, {
...
RegisterNetEvent('police:client:deleteObject', function()
    ...
    if dist < 5.0 then
        Core.Functions.Progressbar("remove_object", Lang:t('progressbar.remove_object'), 2500, false, true, {
            disableMovement = true,
            disableCarMovement = true,
            disableMouse = false,
            disableCombat = true,
...
RegisterNetEvent('police:client:SpawnSpikeStrip', function()
    if #SpawnedSpikes + 1 < Config.MaxSpikes then
        ...
        Core.Functions.Notify(Lang:t("error.no_spikestripe"), 'error')
    end
end)
