    ...
    if event == "CEventNetworkEntityDamage" then
        ...
        if victimDied and NetworkGetPlayerIndexFromPed(victim) == PlayerId() and IsEntityDead(PlayerPedId()) then
            ...
            elseif InLaststand and not isDead then
                ...
                local weaponLabel = Core.Shared.Weapons[weapon].label or 'Unknown'
                local weaponName = Core.Shared.Weapons[weapon].name or 'Unknown'
                TriggerServerEvent("log:server:CreateLog", "death", Lang:t('logs.death_log_title', {playername = playerName, playerid = GetPlayerServerId(playerid)}), "red", Lang:t('logs.death_log_message', {killername = killerName, playername = playerName, weaponlabel = weaponLabel, weaponname = weaponName}))
