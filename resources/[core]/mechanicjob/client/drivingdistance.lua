...
RegisterNetEvent('vehicletuning:client:UpdateDrivingDistance', function(amount, plate)
                            ...
                            if DamageKey ~= nil then
                                ...
                                if chance == odd then
                                    for k, _ in pairs(Config.Damages) do
                                        ...
                                        TriggerServerEvent('vehicletuning:server:SetPartLevel', plate, k, newDamage)
                                    end
                                end
                            end
