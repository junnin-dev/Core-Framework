Config = {}
Config.UseTarget = GetConvar('UseTarget', 'false') == 'true' -- Use as interações de destino (não altere isso, vá para o seu servidor.cfg e adicione `setR usetarget true` para usá -lo e apenas de verdadeiro ao falso ou o contrário)
